...
public class Androids extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_androids);
    ...
    private void shareIt() {
        ...
        String shareBody = "Android Development Certification at SCTPL";
        sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Android@SCTPL");
